...
SUTRA is a family of larges multi-lingual language (LMLMs) models pioneered by Numeric. SUTRA’s dual-transformer approach extends the power of both MoE and Dense AI language model architectures, delivering cost-efficient multilingual capabilities for over 50+ languages. It powers scalable AI applications for conversation, search, and advanced reasoning, ensuring high-performance across diverse languages, domains and applications.
...
response = agent.run("About SUTRA by Numeric")
print(response.content)
```
