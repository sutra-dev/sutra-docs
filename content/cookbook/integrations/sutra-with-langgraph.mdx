...
SUTRA is a family of large multi-lingual language (LMLMs) models pioneered by Numeric. SUTRA’s dual-transformer approach extends the power of both MoE and Dense AI language model architectures, delivering cost-efficient multilingual capabilities for over 50+ languages. It powers scalable AI applications for conversation, search, and advanced reasoning, ensuring high-performance across diverse languages, domains and applications.

# LangGraph with SUTRA

This notebook demonstrates how to use LangGraph with Sutra, a powerful language model from Numeric. We'll create a simple conversational agent with state management using LangGraph and Sutra's capabilities.

## Get Your API Keys

Before you begin, make sure you have:

1.  A SUTRA API key (Get yours at [Numeric's SUTRA API page](https://www.two.ai/sutra/api))
...
We'll use the ChatOpenAI class to initialize the Sutra model with the appropriate base URL for Numeric's API.
