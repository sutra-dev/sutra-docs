...
Welcome! This directory showcases how to connect [SUTRA](https://www.numeric.tech)—a powerful multilingual language model family by Numeric—with leading frameworks and agentic platforms. These integration notebooks help you leverage SUTRA's capabilities in your own LLM-powered workflows, apps, and pipelines.
