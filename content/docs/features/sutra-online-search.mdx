...
conn = http.client.HTTPSConnection("api.numeric.tech")
...
if not api_key:
    ...
    print("Contact Numeric for enterprise API access: https://www.numeric.tech")
    exit(1)
...
### Usage Instructions
1. Replace `api_key = ""` with your actual Two.ai API key from [Numeric](https://www.numeric.tech).
...
- **Network Errors**: Check your internet connection and ensure the Two.ai API endpoint (`https://api.numeric.tech/v2`) is accessible.
