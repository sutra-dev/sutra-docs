...
if not api_key:
    ...
    print("Get your API key from: https://www.two.ai/sutra/api")
    exit(1)
...
### Usage Instructions
1. Replace `api_key = ""` with your actual Two.ai API key from [Two.ai SUTRA API](https://www.two.ai/sutra/api).
