...
- SUTRA API key from [http://platform.two.ai](http://platform.two.ai).
...
if not api_key:
    ...
    print("Get your API key from: http://platform.two.ai")
    exit(1)
...
### Usage Instructions
1. Replace `api_key = ""` with your actual Two.ai API key from [Two.ai SUTRA API](http://platform.two.ai).
