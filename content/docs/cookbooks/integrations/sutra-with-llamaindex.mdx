...
<div style={{ display: "flex", alignItems: "center", gap: "40px" }}>
  <img src="https://play-lh.googleusercontent.com/_O9p4Z4yucA2NLmZBu9mTJCuBwXeT9NcbtrDN6I8gKlkIPRySV0adOmbyipjSj9Gew" width="120" style={{borderRadius: '30px'}} className='my-0!' />
  <div className='bg-white h-[120px] p-1 rounded-[30px]'>
    <img
        src="https://cdn.sanity.io/images/7m9jw85w/production/c2c8f42f1c93335a80491e3bc27dfbf7ef728d28-121x120.svg?fit=max&auto=format"
        className='m-0! w-[110px] h-[110px]'
    />
  </div>
</div>
