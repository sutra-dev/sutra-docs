...
Pour en savoir plus sur l'utilisation de Sutra avec la **langue
française**, consultez les ressources suivantes :

1.  [Documentation de l'API Sutra](https://docs.two.ai)
2.  [Variantes du modèle Sutra](https://docs.two.ai/models)
3.  [Plus d'informations sur les capacités
    multilingues](https://docs.two.ai/multilingual)

Nous vous encourageons à créer vos propres applications en utilisant
Sutra pour le **français** et d'autres langues indiennes !
