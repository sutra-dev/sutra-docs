...
- **Details**: The SUTRA-V1 API, designed for multilingual conversational tasks, has been replaced by SUTRA-V2, which offers improved performance, image processing, and full compatibility with OpenAI’s API specifications.[](https://www.numeric.tech/blog/sutra-v2-is-here)
