...
| CODE                       | DESCRIPTION |
|----------------------------|-------------|
| **400 – Invalid Format**   | **Cause:** The request body format is invalid.<br />**Solution:** Adjust your request body based on the error message hints. For more details, refer to the [SUTRA API Documentation](/docs). |
| **401 – Authentication Fails** | **Cause:** The API key provided is invalid.<br />**Solution:** Verify your API key. If you don't have one, generate it via the [Numeric](https://www.numeric.tech). |
