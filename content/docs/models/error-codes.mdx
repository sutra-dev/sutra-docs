...
| **401 – Authentication Fails** | **Cause:** The API key provided is invalid.<br />**Solution:** Verify your API key. If you don't have one, generate it via the [developer portal](http://platform.two.ai/). |
