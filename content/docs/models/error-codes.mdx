...
| **422 – Invalid Parameters**   | **Cause:** The request contains invalid or unsupported parameters.<br />**Solution:** Correct the parameters as indicated in the error message. See the [SUTRA API Documentation](https://sutra.apidocumentation.com/version-2/docs/get-started-with-sutra) for more details. |
