...
This guide demonstrates how to use the **SUTRA-V2** model with the Ruby SDK to build multilingual AI applications. SUTRA-V2, developed by Numeric, powers chat and instruction tasks via an OpenAI-compatible API.
...
OpenAI.configure do |config|
  ...
  config.uri_base = 'https://api.numeric.tech/v2' # SUTRA API base URL
end
