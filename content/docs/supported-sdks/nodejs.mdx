...
This guide demonstrates how to use the **SUTRA-V2** model with the NodeJs SDK to build multilingual AI applications. SUTRA-V2, developed by Numeric, powers chat and instruction tasks via an OpenAI-compatible API.
