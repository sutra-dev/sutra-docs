...
This guide demonstrates how to use the **SUTRA-V2** model with the Go SDK to build multilingual AI applications. SUTRA-V2, developed by Numeric, powers chat and instruction tasks via an OpenAI-compatible API.
...
func main() {
	...
	config.BaseURL = "https://api.numeric.tech/v2"
