...
This MDX file documents the **Streamlit-based SUTRA Multilingual Question Generator** application, sourced from the [Sutra Cookbook repository](https://github.com/Shubhwithai/sutra-cookbook/blob/main/starter-apps/Multilingual_Question_Generator/app.py). The app leverages the SUTRA LLM model via LangChain to generate questions from uploaded PDF files or manually entered text in over 50 languages, with streaming responses for a dynamic user experience.
...
- [Complete Source Code](https://github.com/Shubhwithai/sutra-cookbook/tree/main/starter-apps/Multilingual_Question_Generator)
