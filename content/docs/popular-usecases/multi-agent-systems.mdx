...
This notebook demonstrates how to use **SUTRA** with **CrewAI**, a framework for orchestrating role-playing, autonomous AI agents. SUTRA-V2, developed by Numeric, powers multilingual chat and instruction tasks, integrating seamlessly with CrewAI’s collaborative agent workflows.[](https://www.analyticsvidhya.com/blog/2024/01/building-collaborative-ai-agents-with-crewai/)[](https://github.com/crewAIInc/crewAI)
